...
ENV LIFERAY_HOME /opt/liferay-portal-6.2-ce-ga4
...
RUN (cd /tmp && \
    wget http://sourceforge.net/projects/lportal/files/Liferay%20Portal/6.2.3%20GA4/liferay-portal-tomcat-6.2-ce-ga4-20150416163831865.zip -O liferay.zip && \
    unzip liferay.zip -d /opt && rm -f liferay.zip)
